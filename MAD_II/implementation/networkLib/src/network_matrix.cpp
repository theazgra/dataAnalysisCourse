...
namespace azgra::networkLib
{
    ...
    void
    NetworkMatrix::hierarchical_clustering(const uint clusterCount, const char *reportFile, LinkageType linkType, bool calculateCosineSim)
    {
        auto clusters = find_clusters_hierarchical(clusterCount, linkType, false);
    ...
    std::vector<Cluster>
    NetworkMatrix::find_clusters_hierarchical(const uint clusterCount, LinkageType linkType, bool calcalateCosineSim) const
    {
